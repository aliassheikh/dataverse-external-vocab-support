...
- The required files (available in `dist/js/` after linking) are:
  ...
  - `cvocutils.js` : a Javascript file with common methods used by both scripts,
  - `i18n/person-or-org_*.json` : internationalization files for the supported languages.
